...
class DirectMapping(_rdf.store.Store):
    ...
    :param orm_classes:
        ...
        connection produced by :meth:`open` with the given *rdb_args* and
        *rdb_kwargs*, the *rdb_metadata*, and the *base_iri*, indexed by
    ...
    def triples(self, (subject_pattern, predicate_pattern, object_pattern),
        ...
        :rtype: ~[(:class:`rdflib.URIRef`,
                   :class:`rdflib.URIRef`,
                   :class:`rdflib.URIRef` or :class:`rdflib.Literal`
                     or :class:`rdflib.Date` or :class:`rdflib.DateRange`)]
